...
const courses = [
    // Pluralsight courses
    { title: "Authoring and Maintaining GitHub Actions Workflows", description: "Learn to create and manage GitHub Actions workflows effectively.", publisher: "Pluralsight", link: "https://www.pluralsight.com/courses/github-actions-authoring-maintaining-workflows" },
    { title: "Running Jenkins in Kubernetes", description: "Explore how to deploy and manage Jenkins in a Kubernetes environment.", publisher: "Pluralsight", link: "https://app.pluralsight.com/library/courses/jenkins-kubernetes-running" },
    { title: "Managing Docker on Linux Servers (2nd Edition)", description: "Master the skills of managing Docker containers on Linux servers.", publisher: "Pluralsight", link: "#" },
    { title: "Getting Started with NGINX", description: "Learn the fundamentals of NGINX web server and reverse proxy.", publisher: "Pluralsight", link: "https://www.pluralsight.com/courses/nginx-getting-started" },
    { title: "Getting Started with Docker on Windows (3rd Edition)", description: "Dive into running Docker containers on Windows platforms.", publisher: "Pluralsight", link: "https://www.pluralsight.com/courses/docker-windows-getting-started-2023" },
    { title: "Containers and Images: The Big Picture (2nd Edition)", description: "Understand the core concepts of containerization and container images.", publisher: "Pluralsight", link: "https://app.pluralsight.com/library/courses/containers-images-big-picture-2023/table-of-contents" },
    { title: "Getting Started with Jenkins (3rd Edition)", description: "Learn how to set up and use Jenkins for continuous integration and delivery.", publisher: "Pluralsight", link: "https://www.pluralsight.com/courses/jenkins-getting-started-2023" },
    { title: "Getting Started with Ansible (2nd Edition)", description: "Explore automation with Ansible for configuration management and orchestration.", publisher: "Pluralsight", link: "https://www.pluralsight.com/courses/ansible-getting-started" },
    ...
    { title: "Getting Started with Docker Swarm (2nd Edition)", description: "Learn to orchestrate Docker containers using Docker Swarm mode.", publisher: "Pluralsight", link: "https://app.pluralsight.com/courses/docker-swarm-getting-started/" },
